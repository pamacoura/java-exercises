...
public class MethodExercises {
    ...
    public static void main(String[] args) {
        ...
        MethodExercises.greet("SAMBA");
        // - Call add with two numbers and print the result
        System.out.println(MethodExercises.add(2,7));
        // - Call isEven with a number and print whether it is even
        System.out.println(MethodExercises.isEven(3));
        // - Call max with two numbers and print the larger one
        System.out.println(MethodExercises.max(4,2));
        // - Call factorial with 5 and print the result
        System.out.println(MethodExercises.factorial(5));
        // - Call both multiply methods and print their results
        System.out.println(MethodExercises.multiply(2,3));
        System.out.println(MethodExercises.multiply(2,3,4));
