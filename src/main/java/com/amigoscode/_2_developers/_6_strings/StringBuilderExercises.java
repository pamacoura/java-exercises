...
public class StringBuilderExercises {
    ...
    public static String insertMiddleName(String fullName, String middleName) {
        ...
        //  Convert to String and return.
        var stringBuilder=new StringBuilder(fullName);
        var spacePosition=stringBuilder.indexOf(" ");
        stringBuilder.insert(spacePosition+1,middleName+" ");
        return stringBuilder.toString();
    }
    ...
    public static String convertDemo(String text) {
        ...
        var ch=sb.toString();
        ch=ch.toUpperCase();
        var sbUpperCase=new StringBuilder(ch);
        sbUpperCase.append("!!!");
