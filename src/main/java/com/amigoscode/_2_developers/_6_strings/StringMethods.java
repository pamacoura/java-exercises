...
public class StringMethods {
    ...
    public static String compareEquality(String a, String b) {
        ...
        var firstComparaison= a.equals(b);
        var secondComparaison= a.equalsIgnoreCase(b);
        return String.format("equals: %b, equalsIgnoreCase: %b",firstComparaison,secondComparaison);
    }
    ...
    public static String searchString(String text, String keyword) {
        ...
        var contain=text.contains(keyword);
        var ind=text.indexOf(keyword);
        return String.format("contains: %b, indexOf: %s",contain,ind);
    }
